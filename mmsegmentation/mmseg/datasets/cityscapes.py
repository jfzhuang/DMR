...
from .custom import CustomDataset, CustomTemporalDataset
...
@DATASETS.register_module()
class CityscapesTemporalDataset(CustomTemporalDataset):
    CLASSES = (
        'road',
        'sidewalk',
        'building',
    ...
    def __init__(self, **kwargs):
        super(CityscapesTemporalDataset, self).__init__(
            img_suffix='_leftImg8bit.png', seg_map_suffix='_gtFine_labelTrainIds.png', **kwargs
        )
