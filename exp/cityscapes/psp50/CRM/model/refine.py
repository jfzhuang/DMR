...
from lib.net.transformer import CRM, Transformer
...
class SegRefine(nn.Module):
    def __init__(self, num_classes=19):
        ...
        self.CRM = CRM(dim=512, depth=1, heads=2, mlp_dim=256, pe_dim=(128, 256), use_checkpoint=True)
    ...
    def forward(self, im_list, gt=None):
        ...
        feat_query = self.CRM(feat_0, feat_1, feat_2)
